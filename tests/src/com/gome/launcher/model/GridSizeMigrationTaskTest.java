...
import com.gome.launcher.config.ProviderConfig;
import com.gome.launcher.util.TestLauncherProvider;
...
public class GridSizeMigrationTaskTest extends ProviderTestCase2<TestLauncherProvider> {
    private static final String TAG = "GridSizeMigrationTaskTest";

    ///M: Disable for NEC case is not ready, fix after D-day.
    ...
    private static final String TEST_PACKAGE = "com.gome.launcher.validpackage";
    ...
    public void testHotseatMigration_apps_dropped() throws Exception {
        Log.d(TAG, "testHotseatMigration_apps_dropped");
        if (DISABLED) return;
        long[] hotseatItems = {
    ...
    public void testHotseatMigration_shortcuts_dropped() throws Exception {
        Log.d(TAG, "testHotseatMigration_shortcuts_dropped");
        if (DISABLED) return;
        long[] hotseatItems = {
                addItem(APPLICATION, 0, HOTSEAT, 0, 0),
    ...
    public void testWorkspace_empty_row_column_removed() throws Exception {
        Log.d(TAG, "testWorkspace_empty_row_column_removed");
        if (DISABLED) return;
    ...
    public void testWorkspace_new_screen_created() throws Exception {
        Log.d(TAG, "testWorkspace_new_screen_created");
        if (DISABLED) return;
        long[][][] ids = createGrid(new int[][][]{{
                {  0,  0,  0,  1},
                {  3,  1,  0,  4},
    ...
    public void testWorkspace_items_merged_in_next_screen() throws Exception {
        Log.d(TAG, "testWorkspace_items_merged_in_next_screen");
        if (DISABLED) return;
        long[][][] ids = createGrid(new int[][][]{{
                {  0,  0,  0,  1},
                {  3,  1,  0,  4},
    ...
    public void testWorkspace_items_not_merged_in_next_screen() throws Exception {
        Log.d(TAG, "testWorkspace_items_not_merged_in_next_screen");
        if (DISABLED) return;

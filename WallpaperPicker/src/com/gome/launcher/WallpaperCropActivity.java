...
import com.gome.launcher.base.BaseActivity;
...
public class WallpaperCropActivity extends BaseActivity implements Handler.Callback {
    ...
    protected void init() {
        ...
        if (WallpaperUtils.GM_LAUNCHER) {
            ...
            actionBar.getCustomView().findViewById(R.id.complete).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    actionBar.hide();
...
//                        overridePendingTransition(0, R.anim.fade_out);
        ...
        NycWallpaperUtils.executeCropTaskAfterPrompt(this, cropTask, getOnDialogCancelListener(),null);
    }

    protected void cropImageAndSetWallpaper(Resources res, final int resId,
                                            final boolean finishActivityWhenDone, final boolean shouldFadeOutOnFinish) {

        Log.i(LOGTAG,"wallpaperCropActivity cropImageAndSetWallpaper");
...
//                        overridePendingTransition(R.anim.gome_activity_close_enter,R.anim.gome_activity_close_exit);
        ...
        ItemSelectListener itemSelectListener = new ItemSelectListener() {
            @Override
        ...
        NycWallpaperUtils.executeCropTaskAfterPrompt(this, cropTask, getOnDialogCancelListener(),itemSelectListener);
    }
...
//                    overridePendingTransition(0, R.anim.fade_out);
    ...
    public static class CropViewScaleAndOffsetProvider {
        ...
        public void updateCropView(WallpaperCropActivity a, TiledImageRenderer.TileSource src) {
            ...
            float screenHeight = a.mCropView.getHeight() / scale;
            center.x = screenWidth / 2 + offset * (crop.width() - screenWidth) + crop.left;
            center.y = screenHeight / 2 +  crop.top;

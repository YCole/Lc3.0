...
public class BitmapUtils {
    ...
    public static void savePNGAsFile(Context context) {
        try {
            Bitmap bitmap = drawableToBitmap(WallpaperUtils.getCurrentWallpaperDrawable());
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            bitmap.compress(Bitmap.CompressFormat.JPEG, 100, baos);
            InputStream in = new ByteArrayInputStream(baos.toByteArray());
            File imageFile = new File(context.getFilesDir()+"/wallpaper"+".png");
            imageFile.createNewFile();
            FileOutputStream imageFileStream =
                    context.openFileOutput(imageFile.getName(), Context.MODE_PRIVATE);
    ...
    private static Bitmap drawableToBitmap(Drawable drawable) {
        //GM13C-3216 fix bug weijiaqi 2018/2/2 start
        Bitmap bitmap = Bitmap.createBitmap(
                drawable.getIntrinsicWidth(),
                drawable.getIntrinsicHeight(),
                Bitmap.Config.ARGB_8888);
        //GM13C-3216 fix bug  weijiaqi 2018/2/2 end

...
public class BitmapRegionTileSource implements TiledImageRenderer.TileSource {
    ...
    public static class DrawableBitmapSource extends BitmapSource {

        private Drawable mDrawable;

        public DrawableBitmapSource(Drawable drawable) {
            mDrawable = drawable;
        }

        private Bitmap drawableToDrawable() {
            Bitmap bitmap = Bitmap.createBitmap(
                    ...
                    mDrawable.getOpacity() != PixelFormat.OPAQUE ? Bitmap.Config.ARGB_8888
        ...
        private InputStream regenerateInputStream() {
            Bitmap bitmap = drawableToDrawable();

...
import com.gome.launcher.FolderPagedView;
...
public class FolderAccessibilityHelper extends DragAndDropAccessibilityDelegate {
    ...
    protected String getLocationDescriptionForIconDrop(int id) {
        return mContext.getString(com.gome.launcher.R.string.move_to_position, id + mStartPosition + 1);
    }

    @Override
    protected String getConfirmationForIconDrop(int id) {
        return mContext.getString(com.gome.launcher.R.string.item_moved);
    }
}

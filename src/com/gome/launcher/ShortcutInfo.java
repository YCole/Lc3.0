...
public class ShortcutInfo extends ItemInfo {
    ...
    void onAddToDatabase(Context context, ContentValues values) {
        ...
        values.put(LauncherSettings.Favorites.ICON_URL, iconUrl);
    ...
    public boolean isQueryFromDB() {
        return isQueryFromDB;
    }

    public void setQueryFromDB(boolean queryFromDB) {
        isQueryFromDB = queryFromDB;
    }

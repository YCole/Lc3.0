...
import com.gome.launcher.CustomAppWidget;
...
public class TestingUtils {
    ...
    public static final String MEMORY_TRACKER = "com.gome.launcher.testing.MemoryTracker";
    public static final String ACTION_START_TRACKING = "com.gome.launcher.action.START_TRACKING";
    ...
    public static final String DUMMY_WIDGET = "com.gome.launcher.testing.DummyWidget";
    ...
    public static void addWeightWatcher(Launcher launcher) {
        if (MEMORY_DUMP_ENABLED) {
            ...
            ((FrameLayout) launcher.findViewById(com.gome.launcher.R.id.launcher)).addView(watcher,

...
public final class WallpaperUtils {
    ...
    public static final boolean GM_LAUNCHER = true;
    public static final String WALLPAPER_PREFERENCES_KEY = "com.gome.launcher.wallpaper.prefs";
    public static final String SAVED_RES_ID = "saved_res_id";
    public static final String SAVED_FLAG = "saved_flag";
    public static final String FIRST_LAUNH_FLAG = "first_launch";
    ...
    public static Point getDefaultWallpaperSize(Resources res, WindowManager windowManager) {
        if (sDefaultWallpaperSize == null) {
            ...
            if (res.getConfiguration().smallestScreenWidthDp >= 720) {
                ...
                defaultWidth = WallpaperUtils.GM_LAUNCHER ? minDim :
                        Math.max((int) (minDim * WALLPAPER_SCREENS_SPAN), maxDim);
                defaultHeight = maxDim;
            }
    ...
    public static SharedPreferences getPrefs() {
        return LauncherApplication.getAppContext().getSharedPreferences(
                WALLPAPER_PREFERENCES_KEY, Context.MODE_MULTI_PROCESS);
    }
    ...
    public static Drawable getCurrentWallpaperDrawable() {
        return WallpaperManager.getInstance(LauncherApplication.getAppContext()).getDrawable();
    }

...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.gome.launcher.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.gome.launcher.managedusers.prefs";

...
import com.gome.launcher.DragLayer.TouchCompleteListener;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                mLongPressHelper.cancelLongPress();
                //added by liuning for ignore click widget event in appmanage mode on 2017/10/18 start
                if (mDragLayer.getLauncher().mWorkspace.isInAppManageMode()) {
                    return true;
                }
                //added by liuning for ignore click widget event in appmanage mode on 2017/10/18 end
                break;

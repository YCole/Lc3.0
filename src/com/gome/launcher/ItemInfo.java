...
public class ItemInfo {
    ...
    //-------------------------------end--------------///
    public long appDownLoadStatus= BitmapInfo.NONE;
    ...
    /**
     * 是否属于items
     * add huanghaihao in 2017/8/23
     *
     * @param items
     * @return
     */
    public boolean belong(List<? extends ItemInfo>  items) {
        for (ItemInfo app : items) {
            if (app.id == id) {
                return true;
            }
        }

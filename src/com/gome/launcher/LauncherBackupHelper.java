...
import com.gome.launcher.LauncherSettings.WorkspaceScreens;
import com.gome.launcher.backup.nano.BackupProtos;
import com.gome.launcher.backup.nano.BackupProtos.CheckedMessage;
import com.gome.launcher.backup.nano.BackupProtos.DeviceProfieData;
import com.gome.launcher.backup.nano.BackupProtos.Favorite;
import com.gome.launcher.backup.nano.BackupProtos.Journal;
import com.gome.launcher.backup.nano.BackupProtos.Key;
import com.gome.launcher.backup.nano.BackupProtos.Resource;
import com.gome.launcher.backup.nano.BackupProtos.Screen;
import com.gome.launcher.backup.nano.BackupProtos.Widget;
                ...
                try {
                    ...
                    if (mExistingKeys.contains(backupKey)) {
                        ...
                        if (backupUpIconCount < MAX_ICONS_PER_PASS) {
                            ...
                            if (icon != null && !mIconCache.isGomeDefaultIcon(icon, myUserHandle)) {

...
public class FolderInfo extends ItemInfo {
    ...
    /**
     * Add more app or shortcut
     *
     * @param items
     */
    public void addAll(List<ShortcutInfo> items) {
        contents.addAll(items);
        for (int i = 0; i < listeners.size(); i++) {
            listeners.get(i).onAddAll(items);
        }
        itemsChanged();
    }
    ...
    /**
     * Remove an more or shortcut. Does not change the DB.
     *
     * @param items
     */
    public void removeAll(List<ShortcutInfo> items) {

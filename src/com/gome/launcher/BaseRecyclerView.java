...
public abstract class BaseRecyclerView extends RecyclerView
    ...
    protected abstract boolean isScrollBars();//add by rongwenzhao show scrollbar or not 2017-6-27
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if(isScrollBars()) {//if case add by rongwenzhao to show scrollbar or not 2017-6-27
            onUpdateScrollbar(0);

...
public class GridSizeMigrationTask {
    ...
    protected boolean migrateHotseat() throws Exception {
        ...
        //linhai update HotseatSize动态变化值 start 2017/7/6
        int requiredCount =  LauncherAppState.isDisableAllApps() ? mDestHotseatSize : mDestHotseatSize-1  ;
        //linhai end  2017/7/6
        ...
        //linhai update newScreenId兼任判断  start 2017/7/6
        // Update screen IDS
    ...
    public static boolean migrateGridIfNeeded(Context context) {
        ...
        String hotseatSizeString = getPointString(idp.numHotseatIconsMax, idp.hotseatAllAppsRank);
        ...
        try {
            ...
            //linhai add Hotseat 为动态坑位,比较最大坑位值 start for 2017/10/25
            if (srcHotseatSize.x != idp.numHotseatIconsMax ||
                    srcHotseatSize.y != idp.hotseatAllAppsRank) {
                //linhai end  Hotseat 为动态坑位，比较最大坑位值 start for 2017/10/25
                // Migrate hotseat.

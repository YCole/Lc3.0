...
public class LauncherAppWidgetProviderInfo extends AppWidgetProviderInfo {
    ...
    public void initSpans() {
        ...
        //modified by liuning for calculate the cell Width and height ignore landscape on 2017/12/8 start
...
//                idp.portraitProfile.widthPx - paddingPort.left - paddingPort.right - idp.portraitProfile.cellLayoutLeftRightPadding * 2),
//                idp.numColumns);
...
//                idp.numRows);
        float smallestCellWidth = DeviceProfile.calculateCellWidth(
                idp.portraitProfile.availableWidthPx - paddingPort.left - paddingPort.right - idp.portraitProfile.cellLayoutLeftRightPadding * 2,
                idp.numColumns);
        float smallestCellHeight = DeviceProfile.calculateCellWidth(
                idp.portraitProfile.availableHeightPx - paddingPort.top - paddingPort.bottom,
                idp.numRows);
        //modified by liuning for calculate the cell Width and height ignore landscape on 2017/12/8 end

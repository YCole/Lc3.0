...
//    private static  DownloadAnimation sDownloadAnimation;
    ...
    private static final float[] PRE_DOWNLOAD = new float[]{0.5f, 1.03f};
...
//    }
    ...
    private void startAnimation(final float[] point, final AnimatorListener animatorListener, long duration) {
        ...
        scaleXY.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                if (null != animatorListener) {
                    Log.e("admin", getInterpolator() + "|" + point[0]);
